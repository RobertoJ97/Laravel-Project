...
@section('content')
<div class="row mt-4">
    <h4 class="text-center border-bottom">Registro de SET</h4>
</div>
...
<div class="row ml-4 mr-4 pl-4 pr-4">
    <form action="/set" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="categoria_docente" name="categoria_docente" placeholder="Ingrese la categoria docente">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="grado_cientifico" name="grado_cientifico" placeholder="Ingrese el grado cientifico">
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-center">
                <button type="submit" onClick="return ValidarSET();" class="btn btn-primary mb-2">Registrar SET</button>
            </div>
            <div class="col-md-4"></div>
        </div>
    </form>
